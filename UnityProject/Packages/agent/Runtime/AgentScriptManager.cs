...
namespace LLMAgent
{
    ...
    public class AgentScriptManager : IDisposable
    {
        ...
        private Func<string, string, string, string, string, string, int, string> configureAgent;
        ...
        public void Initialize(string resourceRoot, Action onReady = null)
        {
            ...
            try
            {
                ...
                configureAgent = moduleExports.Get<Func<string, string, string, string, string, string, int, string>>("configureAgent");
        ...
        /// <param name="wireApi">Wire API to use: responses or chat_completions.</param>
        /// <param name="reasoningEffort">Optional reasoning effort for supported models.</param>
        /// <param name="textVerbosity">Optional text verbosity for supported models.</param>
        /// <param name="maxSteps">Maximum tool-call steps per generation. 0 or negative = unlimited.</param>
        public string ConfigureAgent(string apiKey, string baseURL = "", string model = "", string wireApi = "responses", string reasoningEffort = "", string textVerbosity = "", int maxSteps = 0)
        {
            ...
            try
            {
                return configureAgent(apiKey, baseURL, model, wireApi, reasoningEffort, textVerbosity, maxSteps);
            }
            catch (Exception ex)
            {
