...
- `duel_ai_difficulty.json` 已配置电脑对局难度选项、KataGo human policy profile、基础访问次数、基础候选点数量、失误率、采样温度、基础最大亏损目数、访问权重、提前虚手开关、思考延迟，以及 9 路、13 路、19 路分别使用的实时访问上限、候选点数量和最大亏损目数覆盖值。
