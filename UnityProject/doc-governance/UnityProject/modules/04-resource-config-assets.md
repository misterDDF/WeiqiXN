...
- The current runtime asset entries include the shared black and white chess-board materials used by ownership overlay/latest-move marker rendering, plus code-loaded audio clips used by `GameAudio`.
