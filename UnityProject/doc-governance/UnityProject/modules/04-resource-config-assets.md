...
- `ui_page.json` 已配置 LoadingPage、MainMenuPage、UserInfoPopup、ReplayPage、DuelSetupPopup、LanRoomPopup、DuelPage、ConfirmPopup、OgsFriendListPopup、RecentReplayListPopup 和 OgsFriendProfilePopup。
