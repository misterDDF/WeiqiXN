...
- 没有账号身份和完整房间生命周期；当前玩家资料同步只覆盖座位显示名，座位只覆盖创建房间时 host 选择黑白或猜先，不包含房间内换座、观战或跨设备账号。
